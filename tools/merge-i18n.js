...
const SOURCES = ['content.json', 'users-extra.json', 'users-filters.json', 'followers.json',
                 ...
                 'exports.json', 'login.json', 'settings.json', 'releases.json', 'a11y.json', 'quickaccess.json', 'edits-batch.json', 'riyal.json', 'emptybalance.json', 'idtype.json', 'singleintro.json', 'rule2loyalty.json'];
