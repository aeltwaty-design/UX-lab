...
const SOURCES = ['content.json', 'users-extra.json', 'users-filters.json', 'followers.json',
                 ...
                 'exports.json', 'login.json', 'settings.json', 'releases.json', 'a11y.json', 'quickaccess.json'];
// prefixes whose page keys are replaced wholesale, so a deleted string really goes
const OWNED = ['transfers.', 'transactions.', 'charge.', 'exports.', 'login.', 'otp.', 'settings.', 'releases.', 'quick.'];
const src = { en: {}, ar: {} };
